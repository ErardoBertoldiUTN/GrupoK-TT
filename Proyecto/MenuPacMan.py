...
def pantallaMenu():
    ...
    Descripcion5=FuenteDescripcion.render("Al final se daran por pantalla los puntajes obtenidos por cada jugador. Mucha suerte, a disfrutar el juego!!!",0,(200,60,80))
